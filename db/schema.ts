...
export const jdrGoogleSheets = sqliteTable("jdr_google_sheets", {
  key: text("key", { enum: ["classes", "characters", "campaigns", "campaign_characters", "character_relations", "admin_todos", "inventory", "shops", "npcs", "tabletop", "vocabulary"] }).primaryKey(),
