...
import { useCallback, useMemo, useRef, useState, type MutableRefObject, type PointerEvent as ReactPointerEvent, type ReactNode } from "react"
...
export function SheetGrid({
  ...
  return <div className="sticky top-0 z-20 flex h-[calc(100svh-3.5rem-var(--eraser-titlebar,0px))] flex-col overflow-hidden rounded-xl border bg-background/60">
    <SheetGridToolbar targetRef={activeRef} ready={toolbarReady} leading={toolbarLeading} trailing={toolbarTrailing} onReset={() => { setLayout(emptyLayout); setPreview({ columns: {}, rows: {} }) }} />
